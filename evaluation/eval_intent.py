...
from evaluation.test_cases_holdout import HOLDOUT_CASES as TEST_CASES

RESULTS_FILE = Path(__file__).parent / "results" / "intent_eval2.json"
...
def main() -> None:
    ...
    for query, expected, difficulty in TEST_CASES:
